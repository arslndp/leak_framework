 ...
 */
	...
	$serverAccept = $_SERVER["HTTP_ACCEPT"];

	//asal kasih fitur aja sihh :p

	$httpCookie = $_SERVER["HTTP_COOKIE"];
	

	$platform['phone'] = 'samsung';
	$platform['phone'] = 'iphone';
	$platform['phone'] = 'nokia';
	$platform['phone'] = 'firefoxOS';
	$platform['phone'] = 'chromeOS';
	$platform['phone'] = 'ubuntuTouch';
	$platform['phone'] = 'windows phone';
	$platform['phone'] = 'symbian';
	$platform['phone'] = 'java';
	$platform['phone'] = 'nethunter';
	$platform['phone'] = 'nintendo';
